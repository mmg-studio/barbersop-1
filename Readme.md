...
* Студент: [Artem](https://vk.com).
* Наставник: `учитэл Макс`.
...
[Откройте мастер-репозиторий](https://github.com/mmg-studio/barbersop-1.git) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
